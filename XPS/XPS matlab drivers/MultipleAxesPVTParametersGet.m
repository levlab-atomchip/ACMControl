...
% lib call
[errorCode, GroupName, FileName, CurrentElementNumber] = calllib('XPS_C8_drivers', 'MultipleAxesPVTParametersGet', socketId, GroupName, FileName, CurrentElementNumber);
