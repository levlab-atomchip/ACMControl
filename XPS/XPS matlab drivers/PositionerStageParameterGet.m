...
% lib call
[errorCode, PositionerName, ParameterName, ParameterValue] = calllib('XPS_C8_drivers', 'PositionerStageParameterGet', socketId, PositionerName, ParameterName, ParameterValue);
