...
% lib call
[errorCode, PositionerName, GPIOName] = calllib('XPS_C8_drivers', 'PositionerAnalogTrackingPositionParametersSet', socketId, PositionerName, GPIOName, Offset, Scale, Velocity, Acceleration);
