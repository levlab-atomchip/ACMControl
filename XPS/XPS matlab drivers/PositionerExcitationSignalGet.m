...
% lib call
[errorCode, PositionerName, Mode, Frequency, Amplitude, Time] = calllib('XPS_C8_drivers', 'PositionerExcitationSignalGet', socketId, PositionerName, Mode, Frequency, Amplitude, Time);
