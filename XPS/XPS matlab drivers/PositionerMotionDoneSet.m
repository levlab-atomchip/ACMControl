...
% lib call
[errorCode, PositionerName] = calllib('XPS_C8_drivers', 'PositionerMotionDoneSet', socketId, PositionerName, PositionWindow, VelocityWindow, CheckingTime, MeanPeriod, TimeOut);
