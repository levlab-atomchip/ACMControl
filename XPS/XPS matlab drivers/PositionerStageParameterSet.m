...
% lib call
[errorCode, PositionerName, ParameterName, ParameterValue] = calllib('XPS_C8_drivers', 'PositionerStageParameterSet', socketId, PositionerName, ParameterName, ParameterValue);
