...
% lib call
[errorCode, GroupName, StartElement, EndElement, TimeInterval] = calllib('XPS_C8_drivers', 'MultipleAxesPVTPulseOutputGet', socketId, GroupName, StartElement, EndElement, TimeInterval);
