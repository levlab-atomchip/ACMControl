...
% lib call
[errorCode, PositionerName, GPIOName, Offset, Scale, DeadBandThreshold, Order, Velocity, Acceleration] = calllib('XPS_C8_drivers', 'PositionerAnalogTrackingVelocityParametersGet', socketId, PositionerName, GPIOName, Offset, Scale, DeadBandThreshold, Order, Velocity, Acceleration);
