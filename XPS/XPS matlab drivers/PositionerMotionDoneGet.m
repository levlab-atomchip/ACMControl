...
% lib call
[errorCode, PositionerName, PositionWindow, VelocityWindow, CheckingTime, MeanPeriod, TimeOut] = calllib('XPS_C8_drivers', 'PositionerMotionDoneGet', socketId, PositionerName, PositionWindow, VelocityWindow, CheckingTime, MeanPeriod, TimeOut);
