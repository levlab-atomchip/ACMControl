...
% lib call
[errorCode, TCLFileName, TaskName, InputParametersList, OutputParametersList] = calllib('XPS_C8_drivers', 'TCLScriptExecuteAndWait', socketId, TCLFileName, TaskName, InputParametersList, OutputParametersList);
