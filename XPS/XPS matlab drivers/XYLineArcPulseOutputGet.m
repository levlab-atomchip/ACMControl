...
% lib call
[errorCode, GroupName, StartLength, EndLength, PathLengthInterval] = calllib('XPS_C8_drivers', 'XYLineArcPulseOutputGet', socketId, GroupName, StartLength, EndLength, PathLengthInterval);
