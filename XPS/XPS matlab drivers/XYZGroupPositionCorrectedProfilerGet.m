...
% lib call
[errorCode, GroupName, CorrectedProfilerPositionX, CorrectedProfilerPositionY, CorrectedProfilerPositionZ] = calllib('XPS_C8_drivers', 'XYZGroupPositionCorrectedProfilerGet', socketId, GroupName, PositionX, PositionY, PositionZ, CorrectedProfilerPositionX, CorrectedProfilerPositionY, CorrectedProfilerPositionZ);
