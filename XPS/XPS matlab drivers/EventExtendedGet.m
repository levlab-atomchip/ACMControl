...
% lib call
[errorCode, EventTriggerConfiguration, ActionConfiguration] = calllib('XPS_C8_drivers', 'EventExtendedGet', socketId, ID, EventTriggerConfiguration, ActionConfiguration);
