...
% lib call
[errorCode, PositionerName, UserMinimumTarget, UserMaximumTarget] = calllib('XPS_C8_drivers', 'PositionerUserTravelLimitsGet', socketId, PositionerName, UserMinimumTarget, UserMaximumTarget);
