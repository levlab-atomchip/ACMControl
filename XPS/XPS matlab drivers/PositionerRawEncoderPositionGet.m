...
% lib call
[errorCode, PositionerName, RawEncoderPosition] = calllib('XPS_C8_drivers', 'PositionerRawEncoderPositionGet', socketId, PositionerName, UserEncoderPosition, RawEncoderPosition);
