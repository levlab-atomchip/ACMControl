...
% lib call
[errorCode, PositionerName, MinimumPosition, MaximumPosition, EnableState] = calllib('XPS_C8_drivers', 'PositionerPositionCompareAquadBWindowedGet', socketId, PositionerName, MinimumPosition, MaximumPosition, EnableState);
