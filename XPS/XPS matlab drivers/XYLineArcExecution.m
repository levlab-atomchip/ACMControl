...
% lib call
[errorCode, GroupName, TrajectoryFileName] = calllib('XPS_C8_drivers', 'XYLineArcExecution', socketId, GroupName, TrajectoryFileName, Velocity, Acceleration, ExecutionNumber);
