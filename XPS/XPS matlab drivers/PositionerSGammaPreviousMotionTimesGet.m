...
% lib call
[errorCode, PositionerName, SettingTime, SettlingTime] = calllib('XPS_C8_drivers', 'PositionerSGammaPreviousMotionTimesGet', socketId, PositionerName, SettingTime, SettlingTime);
