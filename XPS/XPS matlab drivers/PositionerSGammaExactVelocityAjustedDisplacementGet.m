...
% lib call
[errorCode, PositionerName, AdjustedDisplacement] = calllib('XPS_C8_drivers', 'PositionerSGammaExactVelocityAjustedDisplacementGet', socketId, PositionerName, DesiredDisplacement, AdjustedDisplacement);
