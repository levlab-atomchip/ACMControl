...
EXPORT int ControllerStatusGet (int SocketIndex, int * ControllerStatus);  /* Read controller current status */
EXPORT int ControllerStatusStringGet (int SocketIndex, int ControllerStatusCode, char * ControllerStatusString);  /* Return the controller status string corresponding to the controller status code */
...
EXPORT int PositionerCurrentVelocityAccelerationFiltersGet (int SocketIndex, char * PositionerName, double * CurrentVelocityCutOffFrequency, double * CurrentAccelerationCutOffFrequency);  /* Get current velocity and acceleration cutoff frequencies */
EXPORT int PositionerCurrentVelocityAccelerationFiltersSet (int SocketIndex, char * PositionerName, double CurrentVelocityCutOffFrequency, double CurrentAccelerationCutOffFrequency);  /* Set current velocity and acceleration cutoff frequencies */
...
EXPORT int PositionerExcitationSignalGet (int SocketIndex, char * PositionerName, int * Mode, double * Frequency, double * Amplitude, double * Time);  /* Read disturbing signal parameters */
EXPORT int PositionerExcitationSignalSet (int SocketIndex, char * PositionerName, int Mode, double Frequency, double Amplitude, double Time);  /* Update disturbing signal parameters */
EXPORT int PositionerExternalLatchPositionGet (int SocketIndex, char * PositionerName, double * Position);  /* Read external latch position */
...
EXPORT int PositionerDACOffsetGet (int SocketIndex, char * PositionerName, short * DACOffset1, short * DACOffset2);  /* Get DAC offsets */
EXPORT int PositionerDACOffsetSet (int SocketIndex, char * PositionerName, short DACOffset1, short DACOffset2);  /* Set DAC offsets */
EXPORT int PositionerDACOffsetDualGet (int SocketIndex, char * PositionerName, short * PrimaryDACOffset1, short * PrimaryDACOffset2, short * SecondaryDACOffset1, short * SecondaryDACOffset2);  /* Get dual DAC offsets */
EXPORT int PositionerDACOffsetDualSet (int SocketIndex, char * PositionerName, short PrimaryDACOffset1, short PrimaryDACOffset2, short SecondaryDACOffset1, short SecondaryDACOffset2);  /* Set dual DAC offsets */
...
EXPORT int GatheringUserDatasGet (int SocketIndex, double * UserData1, double * UserData2, double * UserData3, double * UserData4, double * UserData5, double * UserData6, double * UserData7, double * UserData8);  /* Return user data values */
