...
% lib call
[errorCode, PositionerName, PCOPulseWidth, EncoderSettlingTime] = calllib('XPS_C8_drivers', 'PositionerPositionComparePulseParametersGet', socketId, PositionerName, PCOPulseWidth, EncoderSettlingTime);
