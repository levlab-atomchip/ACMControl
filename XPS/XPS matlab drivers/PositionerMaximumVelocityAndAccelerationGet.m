...
% lib call
[errorCode, PositionerName, MaximumVelocity, MaximumAcceleration] = calllib('XPS_C8_drivers', 'PositionerMaximumVelocityAndAccelerationGet', socketId, PositionerName, MaximumVelocity, MaximumAcceleration);
