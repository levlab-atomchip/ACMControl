...
% lib call
[errorCode, PositionerName, GPIOName] = calllib('XPS_C8_drivers', 'PositionerAnalogTrackingVelocityParametersSet', socketId, PositionerName, GPIOName, Offset, Scale, DeadBandThreshold, Order, Velocity, Acceleration);
