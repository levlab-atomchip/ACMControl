...
% lib call
[errorCode, GroupName, CorrectedProfilerPositionX, CorrectedProfilerPositionY] = calllib('XPS_C8_drivers', 'GroupPositionCorrectedProfilerGet', socketId, GroupName, PositionX, PositionY, CorrectedProfilerPositionX, CorrectedProfilerPositionY);
