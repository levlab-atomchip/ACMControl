...
% lib call
[errorCode, PositionerName, BacklashValue, BacklaskStatus] = calllib('XPS_C8_drivers', 'PositionerBacklashGet', socketId, PositionerName, BacklashValue, BacklaskStatus);
