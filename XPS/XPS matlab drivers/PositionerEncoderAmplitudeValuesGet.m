...
% lib call
[errorCode, PositionerName, CalibrationSinusAmplitude, CurrentSinusAmplitude, CalibrationCosinusAmplitude, CurrentCosinusAmplitude] = calllib('XPS_C8_drivers', 'PositionerEncoderAmplitudeValuesGet', socketId, PositionerName, CalibrationSinusAmplitude, CurrentSinusAmplitude, CalibrationCosinusAmplitude, CurrentCosinusAmplitude);
