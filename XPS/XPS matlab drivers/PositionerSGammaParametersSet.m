...
% lib call
[errorCode, PositionerName] = calllib('XPS_C8_drivers', 'PositionerSGammaParametersSet', socketId, PositionerName, Velocity, Acceleration, MinimumTjerkTime, MaximumTjerkTime);
