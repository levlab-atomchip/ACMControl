...
% lib call
[errorCode, PositionerName, MinimumPosition, MaximumPosition, PositionStep, EnableState] = calllib('XPS_C8_drivers', 'PositionerPositionCompareGet', socketId, PositionerName, MinimumPosition, MaximumPosition, PositionStep, EnableState);
