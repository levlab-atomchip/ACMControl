...
% lib call
[errorCode, PositionerName, KI, NotchFrequency, NotchBandwidth, NotchGain, LowpassFrequency] = calllib('XPS_C8_drivers', 'PositionerDriverFiltersGet', socketId, PositionerName, KI, NotchFrequency, NotchBandwidth, NotchGain, LowpassFrequency);
