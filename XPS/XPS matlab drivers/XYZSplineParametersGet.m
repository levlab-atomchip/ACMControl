...
% lib call
[errorCode, GroupName, FileName, Velocity, Acceleration, CurrentElementNumber] = calllib('XPS_C8_drivers', 'XYZSplineParametersGet', socketId, GroupName, FileName, Velocity, Acceleration, CurrentElementNumber);
