...
% lib call
[errorCode, GroupName, PCORawPositionX, PCORawPositionY] = calllib('XPS_C8_drivers', 'GroupPositionPCORawEncoderGet', socketId, GroupName, PositionX, PositionY, PCORawPositionX, PCORawPositionY);
