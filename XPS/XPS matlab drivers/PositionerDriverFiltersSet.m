...
% lib call
[errorCode, PositionerName] = calllib('XPS_C8_drivers', 'PositionerDriverFiltersSet', socketId, PositionerName, KI, NotchFrequency, NotchBandwidth, NotchGain, LowpassFrequency);
