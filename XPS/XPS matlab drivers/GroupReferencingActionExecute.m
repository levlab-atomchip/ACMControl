...
% lib call
[errorCode, PositionerName, ReferencingAction, ReferencingSensor] = calllib('XPS_C8_drivers', 'GroupReferencingActionExecute', socketId, PositionerName, ReferencingAction, ReferencingSensor, ReferencingParameter);
