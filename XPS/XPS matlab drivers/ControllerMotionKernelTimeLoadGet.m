...
% lib call
[errorCode, CPUTotalLoadRatio, CPUCorrectorLoadRatio, CPUProfilerLoadRatio, CPUServitudesLoadRatio] = calllib('XPS_C8_drivers', 'ControllerMotionKernelTimeLoadGet', socketId, CPUTotalLoadRatio, CPUCorrectorLoadRatio, CPUProfilerLoadRatio, CPUServitudesLoadRatio);
