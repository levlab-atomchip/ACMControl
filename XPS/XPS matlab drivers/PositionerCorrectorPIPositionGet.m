...
% lib call
[errorCode, PositionerName, ClosedLoopStatus, KP, KI, IntegrationTime] = calllib('XPS_C8_drivers', 'PositionerCorrectorPIPositionGet', socketId, PositionerName, ClosedLoopStatus, KP, KI, IntegrationTime);
