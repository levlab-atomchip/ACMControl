...
% lib call
[errorCode, PositionerName, StagePositionOffset, GagePositionOffset] = calllib('XPS_C8_drivers', 'PositionerDriverPositionOffsetsGet', socketId, PositionerName, StagePositionOffset, GagePositionOffset);
