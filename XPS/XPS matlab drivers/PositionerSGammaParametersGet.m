...
% lib call
[errorCode, PositionerName, Velocity, Acceleration, MinimumTjerkTime, MaximumTjerkTime] = calllib('XPS_C8_drivers', 'PositionerSGammaParametersGet', socketId, PositionerName, Velocity, Acceleration, MinimumTjerkTime, MaximumTjerkTime);
