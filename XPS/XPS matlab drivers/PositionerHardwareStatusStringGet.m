...
% lib call
[errorCode, PositionerHardwareStatusString] = calllib('XPS_C8_drivers', 'PositionerHardwareStatusStringGet', socketId, PositionerHardwareStatus, PositionerHardwareStatusString);
