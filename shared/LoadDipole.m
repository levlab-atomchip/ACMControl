...
if DipoleBiasSweep
    ...
    if SIGPLUS
        ZBias.ss(DipoleBiasSweepValues(length(DipoleBiasSweepValues)),0,'end')
...
if ~OPTEVAP
    Quadrupole.linear(DipoleEndBGrad,0,DipoleBSweepTime,DipoleBOffSweep+DipoleBSweepTime)
    XBias.linear(XDipole,0,DipoleBSweepTime,DipoleBOffSweep+DipoleBSweepTime)
    YBias.linear(YDipole,0,DipoleBSweepTime,DipoleBOffSweep+DipoleBSweepTime)
    ZBias.linear(DipoleBiasSweepValues(end),0,DipoleBSweepTime,DipoleBOffSweep+DipoleBSweepTime)
    Quadrupole.ss(0,DipoleBOffSweep+DipoleBSweepTime,'end')
    XBias.ss(0,DipoleBOffSweep+DipoleBSweepTime,'end')
    YBias.ss(0,DipoleBOffSweep+DipoleBSweepTime,'end')
    ZBias.ss(0,DipoleBOffSweep+DipoleBSweepTime,'end')
end
