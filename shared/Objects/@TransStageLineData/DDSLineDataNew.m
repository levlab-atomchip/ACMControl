classdef DDSLineData < handle
    ...
    methods
        % Constructor
        function obj = DDSLineData(lineName,ddsnum,channel,refFreq,minFreq,maxFreq,freqTol,dispstat)
            switch nargin
                case 0
                    lineName = '';
                    ddsnum = [];
        ...
        %Accessors
        function value = get.sysFreq(obj)
            tempval = obj.refFreq*20;
            value = min([500e6 tempval]);
